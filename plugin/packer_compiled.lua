...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/nicolas/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["nvim-lint"] = {
    loaded = true,
    path = "/home/nicolas/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["vim-prettier"] = {
    loaded = true,
    path = "/home/nicolas/.local/share/nvim/site/pack/packer/start/vim-prettier",
